...
workbook.save("D:/Study Videos/SQA/Python/pythonSQAProject/PythonSeleniumPractice/UtilitiesDemo/ExcelFiles/DemoExcel.xlsx") # mandatory use for save the data in excel
